...
source     = 'NGC_1672'                         # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '1081~1581'                        # Range in velocity in km/s to extract the line cube.
vel_line   = '1134~1519'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 04h45m42.5s -59d14m50'  # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1331                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
...
name_line      = 'CO21.v0p2'                    # Name of the line, to be used for naming the files

EBexclude      = 'uid___A002_Xb7d0ee_X9777'     # Exclude this EB, conversion to MS cannot be done.
...
execfile('../script/ALMA-TP-tools.py')           # All procedures for data reduction
